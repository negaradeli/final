...
Rentals.delete_all
Rentals.create title: 'Super amazing huge donkey friendly house', price: 400000,
            host_id: host0.id,
...
Rentals.create title: 'Super deal', price: 100, 
            host_id: host1.id,
            location: "Chicago, IL",
...
Rentals.create title: 'Bring your pet here. Zero down with zero interest', price: 3000,
            host_id: host2.id,
...
Rentals.create title: 'I will love your pet as much as I love my wife', price: 1500,
            host_id: host3.id,
            location: "Hope, AR",
...
print "There are now #{Rentals.count} rentals in the database.\n"
